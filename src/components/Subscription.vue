...
<script>
  ...
  new Vue({
    ...
    methods: {
      storeMessage () {
        messagesRef.push({text: this.messageText, nickname: this.nickname, price: this.subPrice, frequency: this.subFrequency, date: this.subStartDate, reminder: this.subReminder})
        this.messageText = ''
        this.nickname = ''
        this.subPrice = ''
        this.subFrequency = ''
      ...
      updateMessage () {
        ...
        messagesRef.child(this.editingMessage.id).update({text: this.messageText, price: this.subPrice, frequency: this.subFrequency, date: this.subStartDate, reminder: this.subReminder})
        this.cancelEditing()
      }
    },
    created () {
